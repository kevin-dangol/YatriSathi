...
public class GuidesBookingController3 {
    ...
    private void checkFXMLInjection() {
        ...
        System.out.println("BookingSearch: " + (BookingSearch != null ? "OK" : "NULL"));
        System.out.println("LocationSort: " + (LocationSort != null ? "OK" : "NULL"));
        System.out.println("Sort: " + (Sort != null ? "OK" : "NULL"));
        System.out.println("CancelButton: " + (CancelButton != null ? "OK" : "NULL"));
        System.out.println("CancelButton1: " + (CancelButton1 != null ? "OK" : "NULL"));
        System.out.println("CancelButton2: " + (CancelButton2 != null ? "OK" : "NULL"));
        System.out.println("CancelButton3: " + (CancelButton3 != null ? "OK" : "NULL"));
        System.out.println("RescheduleButton: " + (RescheduleButton != null ? "OK" : "NULL"));
        System.out.println("RescheduleButton1: " + (RescheduleButton1 != null ? "OK" : "NULL"));
        System.out.println("RescheduleButton2: " + (RescheduleButton2 != null ? "OK" : "NULL"));
        System.out.println("RescheduleButton3: " + (RescheduleButton3 != null ? "OK" : "NULL"));
        System.out.println("BookingName: " + (BookingName != null ? "OK" : "NULL"));
        System.out.println("BookingName1: " + (BookingName1 != null ? "OK" : "NULL"));
        System.out.println("BookingName2: " + (BookingName2 != null ? "OK" : "NULL"));
        System.out.println("BookingName3: " + (BookingName3 != null ? "OK" : "NULL"));
        System.out.println("=============================");
    }
    ...
    private void handleBookingAction(String action, int bookingIndex) {
        try {
            ...
            // 1. Update the booking status in your data file
            // 2. Send notification to the tourists
